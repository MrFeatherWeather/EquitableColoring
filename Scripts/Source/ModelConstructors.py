...
def createASS(g:nx.Graph,H,symm=False,equitConst='standard'):#Konstruiert das Assignment-Modell. Die Parameter bestimmen die Variante des Modells
    ...
    M._G = g
    M._type = "ASS"
    M._eq = (equitConst == 'standard')
    M.update()
    return M,x,w

def createREP(g:nx.Graph, H,symm = True,lowBound=1,equitConst = 'standard'):#Konstruiert das Representatives-Modell. Die Parameter bestimmen die Variante des Modells
